...
async function Viewer() {
  try {
    ...
    //   return viewUser;
    // }
    const response = await fetch('https://helpful-on-corgi.ngrok-free.app/api/v1/device/viewer', {
      method: 'POST',
      headers: {
        'accept': '*/*',
      },
    ...
    let dycryptView = await fetch('https://helpful-on-corgi.ngrok-free.app/api/v1/decript', {
      method: 'POST',
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json',
