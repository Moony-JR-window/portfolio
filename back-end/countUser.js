...
const BaseUrl= 'https://helpful-on-corgi.ngrok-free.app'
...
async function Viewer() {
  try {
    ...
    //   return viewUser;
    // }
    const response = await fetch(`${BaseUrl}/api/v1/device/viewer`, {
      method: 'POST',
      headers: {
        'accept': '*/*',
      },
    ...
    let dycryptView = await fetch(`${BaseUrl}/api/v1/decode`, {
      method: 'POST',
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json',
