...
async function AutoGenerateDevice() {
  ...
  try {
    const response = await fetch('https://moony-server.store/api/v1/device', {
      method: 'POST',
      headers: {
        'accept': '*/*',
...
async function Viewer() {
  try {
    ...
    //   return viewUser;
    // }
    const response = await fetch('https://moony-server.store/api/v1/device/viewer', {
      method: 'POST',
      headers: {
        'accept': '*/*',
      },
    ...
    let dycryptView = await fetch('https://moony-server.store/api/v1/decode', {
      method: 'POST',
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json',
